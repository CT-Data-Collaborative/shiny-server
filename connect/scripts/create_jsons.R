...
#Data to write out:
#write_json(dcf_regions_CT, paste0(path_to_json, "/", "dcf_regions_CT.json"))
#write_json(dcf_regions_1, paste0(path_to_json, "/", "dcf_regions_1.json"))
#write_json(dcf_regions_2, paste0(path_to_json, "/", "dcf_regions_2.json"))
#write_json(dcf_regions_3, paste0(path_to_json, "/", "dcf_regions_3.json"))
#write_json(dcf_regions_4, paste0(path_to_json, "/", "dcf_regions_4.json"))
#write_json(dcf_regions_5, paste0(path_to_json, "/", "dcf_regions_5.json"))
#write_json(dcf_regions_6, paste0(path_to_json, "/", "dcf_regions_6.json"))

#rm(CT_towns, dcf_regions_CT, dcf_regions_1, dcf_regions_2, dcf_regions_3, dcf_regions_4, dcf_regions_5, dcf_regions_6)
...
#Data to write out:
write_json(health_regions, paste0(path_to_json, "/", "health_regions.json"))
write_json(health_rates_regions, paste0(path_to_json, "/", "health_rates_regions.json"))

#rm(health, health_rates, health_regions, health_rates_regions)
#######EARLY CHILDHOOD############################################################################################################################
...
#Data to write out:
write_json(b23_regions, paste0(path_to_json, "/", "b23_regions.json"))
write_json(b23c_regions, paste0(path_to_json, "/", "b23c_regions.json"))

#rm(total_births, b23, b23c, b23_regions, b23c_regions)
...
#Data to write out:
write_json(jj_regions, paste0(path_to_json, "/", "jj_regions.json"))
...
#Data to write out:
write_json(cw_total, paste0(path_to_json, "/", "cw_total.json"))
write_json(cw_gender_total, paste0(path_to_json, "/", "cw_gender_total.json"))
write_json(cw_race_total, paste0(path_to_json, "/", "cw_race_total.json"))
write_json(cw_backfill, paste0(path_to_json, "/", "cw_backfill.json"))
write_json(cw_eey_regions, paste0(path_to_json, "/", "cw_eey_regions.json"))

#rm(cw, cw_ct, cw_eey, cw_gender, cw_gender_ct, cw_race, cw_race_ct, backfill_races, cw_total, cw_gender_total, cw_race_total, cw_backfill, cw_eey_regions)
...
#Data to write out:
write_json(pop_by_age_gender_regions, paste0(path_to_json, "/", "pop_by_age_gender_regions.json"))
write_json(pop_by_race_gender_regions, paste0(path_to_json, "/", "pop_by_race_gender_regions.json"))
write_json(pop_by_age_race_regions, paste0(path_to_json, "/", "pop_by_age_race_regions.json"))
write_json(mhi_df_regions, paste0(path_to_json, "/", "mhi_df_regions.json"))
write_json(mhi_df, paste0(path_to_json, "/", "mhi_df.json"))

#rm(mhi_df, pop_by_age_gender_regions, pop_by_race_gender_regions, pop_by_age_race_regions, mhi_df_regions)
...
#Data to write out:
write_json(bh_CT, paste0(path_to_json, "/", "bh_CT.json"))
write_json(bh_r1, paste0(path_to_json, "/", "bh_r1.json"))
write_json(bh_r2, paste0(path_to_json, "/", "bh_r2.json"))
write_json(bh_r3, paste0(path_to_json, "/", "bh_r3.json"))
write_json(bh_r4, paste0(path_to_json, "/", "bh_r4.json"))
write_json(bh_r5, paste0(path_to_json, "/", "bh_r5.json"))
write_json(bh_r6, paste0(path_to_json, "/", "bh_r6.json"))
write_json(bh_plot1, paste0(path_to_json, "/", "bh_plot1.json"))


#rm(x0to21, dcf_regions, bh_calc, bh_calc_CT, bh_calc_long, bh_calc_wide, bh_df, bh_df_regions, bh_df_regions_calc, bh_plot1, bh_CT, bh_r1, bh_r2, bh_r3, bh_r4, bh_r5, bh_r6)
...
#Data to write out:
write_json(edu, paste0(path_to_json, "/", "edu.json"))
write_json(edu2, paste0(path_to_json, "/", "edu2.json"))
write_json(edu3, paste0(path_to_json, "/", "edu3.json"))
write_json(edu4, paste0(path_to_json, "/", "edu4.json"))
write_json(kei, paste0(path_to_json, "/", "kei.json"))

#rm(districts, edu, edu2, edu3, edu4, kei)
